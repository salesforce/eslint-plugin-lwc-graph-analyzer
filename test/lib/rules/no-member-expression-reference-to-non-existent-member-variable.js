...
ruleTester.run(
    ...
    allRules.rules['no-member-expression-reference-to-non-existent-member-variable'],
    {
        valid: [],
        invalid: [
            {
                ...
                errors: [
                    {
                        message: `Member expression contains reference to non-existent member variable 'tempMemberVar'`
                    }
                ]
            }
        ]
